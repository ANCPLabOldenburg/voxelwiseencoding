...
#bold_files = args.pop('bold_files')
#bold_jsons = args.pop('bold_jsons')
#stim_tsvs = args.pop('stim_tsvs')
#stim_jsons = args.pop('stim_jsons')
# run analysis
ridges, scores, mask, bold_prediction, train_indices, test_indices = \
    run_model_for_subject(**args)

#save outputs
filename_output = create_output_filename_from_args(args['sub'], **args)
